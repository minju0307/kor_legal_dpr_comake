...
from dpr_data import DPRDataset, DPRSampler_train, DPRSampler_test, DPR_collator
...
class Trainer:
    ...
    def __init__(
        ...
        self.train_loader = torch.utils.data.DataLoader(
            ...
            batch_sampler=DPRSampler_train(
...
if __name__ == "__main__":
    ...
    model = BiEncoder()
    train_dataset = DPRDataset("dataset/train_with_id.csv")
    valid_dataset = DPRDataset("dataset/dev_with_id.csv")
    my_trainer = Trainer(
        model=model,
        device=device,
